...
| Initiative | Before cost (yearly) | After cost (yearly) | Savings | Sprint actioned |
|---|---|---|---|---|
| InBody Weight and Body Fat % Graphs * | $3,572 | $359 | $3,213 | 1 |
| Session Attendance Tracking (operational) * | $4,290 | ~$0 | $4,290 | 2 |
| Schedule Preferences | — | — | — | |
| New Sale Form | $5,200 | $2,600 | $2,600 | |
| Cleaning profitability Estimator (Joseph tool) | — | — | — | |
| Cleaner app checklist | — | — | — | |
| Operating expenses, P&L page | — | — | — | |
| Nutrition notebook and migration | — | — | — | |
| Programming notebook and migration | — | — | — | |
| **Total** | | | **$9,103** † | |
